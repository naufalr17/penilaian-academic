...
const LayoutSignIn = () => {
  return (
    <main className="bg-white flex flex-col w-full lg:w-[480px] h-full lg:h-[640px] p-8 lg:p-16 items-center justify-between rounded-none lg:rounded-r-lg shadow-none lg:shadow-2xl lg:shadow-[#292D32]/10">
